  ...
  Map<String, double> scoreMeals(List<Meal> meals, DateTime targetDate) {
    ...
    for (var meal in meals) {
      if (meal.proteinSource != null && meal.proteinSource!.trim().isNotEmpty) {
        ...
        if (meal.lastUsedDate != null) {
          final normalizedLastUsed = DateTime(
            meal.lastUsedDate!.year,
            meal.lastUsedDate!.month,
            meal.lastUsedDate!.day,
          );
        ...
        if (!isRecent && meal.nextUpcomingDate != null) {
          final normalizedNextUpcoming = DateTime(
            meal.nextUpcomingDate!.year,
            meal.nextUpcomingDate!.month,
            meal.nextUpcomingDate!.day,
          );
